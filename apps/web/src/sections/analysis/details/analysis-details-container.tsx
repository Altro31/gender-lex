								...
								<CardHeader>
									<div className="flex items-center justify-between">
										<CardTitle className="flex items-center gap-2">
											...
											{t(
												"Analysis.details.original-text",
											)}
										</CardTitle>
										<Button
											variant="ghost"
									...
									{showSensitiveContent ? (
										...
										<div className="rounded-lg bg-gray-100 p-4 text-center">
											<p className="text-gray-500">
												{t(
													"Analysis.details.hide-content-by-privacity",
												)}
											</p>
										</div>
									)}
							...
							<div className="grid grid-cols-1 gap-4 md:grid-cols-4">
								<Card>
									<CardContent>
										<div className="text-sm text-gray-600">
											{t(
												"Analysis.details.summary.biased-terms",
											)}
										</div>
								...
								<Card>
									<CardContent>
										<div className="text-sm text-gray-600">
											{t(
												"Analysis.details.summary.biased-metaphors",
											)}
										</div>
								...
								<Card>
									<CardContent>
										<div className="text-sm text-gray-600">
											{t(
												"Analysis.details.alternatives.title",
											)}
										</div>
							...
							{analysis.conclusion && (
								<Card>
									<CardHeader>
										<CardTitle>
											{t(
												"Analysis.details.summary.conclusion",
											)}
										</CardTitle>
									</CardHeader>
									<CardContent>
						...
						<TabsContent value="terms" className="space-y-6">
							...
							<Card>
								<CardHeader>
									<CardTitle>
										{t(
											"Analysis.details.terms.biased-terms.title",
										)}
									</CardTitle>
									<CardDescription>
										{t(
									...
									<Card>
										<CardHeader>
											<CardTitle className="flex items-center gap-2">
												...
												/>
												{t(
													"Analysis.details.context.stereotypes",
												)}
											</CardTitle>
										</CardHeader>
										<CardContent className="space-y-3">
											...
											{analysis
												.additionalContextEvaluation
												.stereotype.examples.length >
												0 && (
												<div>
													<h4 className="mb-2 text-sm font-medium text-gray-700">
														{t(
															"Analysis.details.examples",
														)}
														:
													</h4>
								...
								(alternative, index) => (
									<Card key={index}>
										<CardHeader>
											<CardTitle>
												{t(
													"Analysis.details.alternatives.item",
												)}{" "}
												{alternative.alternativeNumber}
											</CardTitle>
											<CardDescription>
												{t(
													"Analysis.details.alternatives.description",
												)}
											</CardDescription>
										</CardHeader>
										<CardContent className="space-y-4">
