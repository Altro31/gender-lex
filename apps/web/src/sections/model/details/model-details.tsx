    ...
    <div className="space-y-2 text-wrap! wrap-break-word!">
        ...
        <CardContent className="space-y-4">
          <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
            <div className="space-y-2">
              ...
              <p className="font-mono text-muted-foreground">{model.name}</p>
            </div>
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
            <div className="space-y-2">
              <div className="text-sm font-medium">{t`Creation date`}</div>
            ...
            {model.usedAt && (
              <div className="space-y-2">
                <div className="text-sm font-medium">{t`Last use`}</div>
                <p className="text-muted-foreground">
                  {new Date(model.usedAt).toLocaleDateString("es-ES", {
                    year: "numeric",
                    month: "long",
                    day: "numeric",
                  })}
            ...
            <div className="space-y-2">
              <div className="text-sm font-medium ">{t`Model ID`}</div>
              <p className="font-mono text-muted-foreground">
                {model.connection.identifier}
              </p>
            </div>
          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            {model.error && (
              <Alert variant="destructive">
                <AlertTriangleIcon />
                <AlertTitle>{getErrorMessage(model.error).title}</AlertTitle>
                <AlertDescription>
