...
export default function ModelForm({ initialData, onSubmit, isEditing = false }: ModelFormProps) {
  ...
  const availableModels = formData.provider ? modelsByProvider[formData.provider] || [] : []
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div className="space-y-2">
          ...
          <Select
            ...
            onValueChange={(value: "active" | "inactive" | "error") => setFormData({ ...formData, status: value })}
          >
            <SelectTrigger>
              <SelectValue />
            </SelectTrigger>
      ...
      <div className="flex justify-end gap-3 pt-4">
        <Button type="submit">{isEditing ? "Actualizar Modelo" : "Crear Modelo"}</Button>
      </div>
    </form>
  )
}
