...
const mockAnalysis: Analysis = {
  ...
  biasedTerms: [
    {
      ...
      explanation: "Uso del masculino genérico que invisibiliza a las mujeres médicas",
      category: "stereotypical",
    },
    {
      content: "las enfermeras",
      influencePercentage: 0.85,
      explanation: "Asociación automática de la enfermería con el género femenino",
      category: "stereotypical",
    },
    {
      content: "madres trabajadoras",
      influencePercentage: 0.65,
      explanation: "Asume que solo las madres tienen responsabilidades de cuidado",
  ...
  biasedMetaphors: [
    {
      ...
      explanation: "Refuerza la idea de que el liderazgo médico es naturalmente masculino",
      historicalContext:
  ...
  additionalContextEvaluation: {
    stereotype: {
      ...
      examples: ["Asociación enfermería-mujer", "Liderazgo médico-hombre"],
      explanation: "El texto perpetúa estereotipos de género en roles profesionales de la salud",
    },
    powerAsymmetry: {
      presence: true,
      influencePercentage: 0.7,
      examples: ["Jerarquía médico-enfermera", "Liderazgo masculino"],
      explanation: "Se evidencia una estructura de poder que favorece roles tradicionalmente masculinos",
    },
    genderRepresentationAbsence: {
      presence: true,
      influencePercentage: 0.65,
      explanation: "Ausencia de representación equitativa de géneros en diferentes roles",
      affectedGroups: ["Mujeres médicas", "Hombres enfermeros", "Personas no binarias"],
    },
    intersectionality: {
      presence: true,
      influencePercentage: 0.6,
      explanation: "No considera la intersección de género con otras identidades",
      excludedGroups: ["Madres solteras", "Padres cuidadores", "Personas LGBTQ+"],
    },
    systemicBiases: {
      presence: true,
      influencePercentage: 0.72,
      examples: ["Estructura jerárquica tradicional", "Roles de género normativos"],
      explanation: "Refleja sesgos sistémicos en la organización del sector salud",
    },
  },
  impactAnalysis: {
    accessToCare: {
      ...
      modificationsExplanation: [
        {
          ...
          modifiedFragment: "Los profesionales de la salud... independientemente de su especialidad",
          reason: "Eliminación de la jerarquización y segmentación por género de las profesiones",
        },
        {
          originalFragment: "los hombres en posiciones de liderazgo médico",
          modifiedFragment: "el liderazgo médico",
          reason: "Neutralización del género en posiciones de autoridad",
        },
        {
          originalFragment: "madres trabajadoras",
          modifiedFragment: "todo el personal que combina responsabilidades laborales y familiares",
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
            <div>
              <h1 className="text-3xl font-bold text-gray-900 mb-2">Detalles del Análisis</h1>
            ...
            <div className="flex items-center gap-3">
              ...
              <Badge variant={analysis.visibility === "public" ? "default" : "secondary"}>
                {analysis.visibility === "public" ? "Público" : "Privado"}
              </Badge>
        ...
        <Tabs defaultValue="overview" className="space-y-6">
          ...
          <TabsContent value="overview" className="space-y-6">
              ...
              <CardHeader>
                <div className="flex items-center justify-between">
                  ...
                  <Button
                    ...
                    className="gap-2"
                  >
                    {showSensitiveContent ? <EyeOff className="h-4 w-4" /> : <Eye className="h-4 w-4" />}
                    {showSensitiveContent ? "Ocultar" : "Mostrar"}
                  </Button>
                </div>
              </CardHeader>
              <CardContent>
                {showSensitiveContent ? (
                  <div className="bg-gray-50 rounded-lg p-4">
                    <p className="text-gray-900 leading-relaxed">{analysis.originalText}</p>
                  </div>
                ) : (
                  <div className="bg-gray-100 rounded-lg p-4 text-center">
                    <p className="text-gray-500">Contenido oculto por privacidad</p>
                  </div>
                )}
              </CardContent>
            </Card>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
              <Card>
                <CardContent className="p-4">
                  <div className="text-2xl font-bold text-red-600">{analysis.biasedTerms.length}</div>
                  <div className="text-sm text-gray-600">Términos Sesgados</div>
                </CardContent>
              </Card>
              <Card>
                <CardContent className="p-4">
                  <div className="text-2xl font-bold text-orange-600">{analysis.biasedMetaphors.length}</div>
                  <div className="text-sm text-gray-600">Metáforas Sesgadas</div>
                </CardContent>
              </Card>
              <Card>
                <CardContent className="p-4">
                  <div className="text-2xl font-bold text-blue-600">{analysis.modifiedTextAlternatives.length}</div>
                ...
                <CardContent className="p-4">
                  <div className="text-2xl font-bold text-green-600">
                    {analysis.additionalContextEvaluation
                      ? Math.round(
                          (Object.values(analysis.additionalContextEvaluation).reduce(
                            (acc, item) => acc + (item.influencePercentage || 0),
                            0,
                          ) /
                            5) *
                            100,
                  ...
                  <div className="text-sm text-gray-600">Influencia Promedio</div>
                </CardContent>
              </Card>
            </div>
            ...
            {analysis.conclusion && (
              <Card>
                ...
                <CardContent>
                  <p className="text-gray-700 leading-relaxed">{analysis.conclusion}</p>
                </CardContent>
              </Card>
            )}
          </TabsContent>
          ...
          <TabsContent value="terms" className="space-y-6">
            ...
            <Card>
              <CardHeader>
                <CardTitle>Términos Sesgados Identificados</CardTitle>
                <CardDescription>
                  Palabras o frases que contienen sesgos de género detectados en el texto
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                {analysis.biasedTerms.map((term, index) => (
                  <div key={index} className="border rounded-lg p-4 space-y-3">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-3">
                        <span className="font-medium text-lg">"{term.content}"</span>
                        <Badge className={getCategoryColor(term.category)}>{getCategoryLabel(term.category)}</Badge>
                      </div>
                      <div className="text-right">
                        <div className="text-sm text-gray-600">Influencia</div>
                        <div className="text-lg font-bold text-red-600">
                          {Math.round(term.influencePercentage * 100)}%
                        </div>
                      </div>
                    </div>
                    <Progress value={term.influencePercentage * 100} className="h-2" />
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Expresiones metafóricas que perpetúan sesgos de género</CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                {analysis.biasedMetaphors.map((metaphor, index) => (
                  <div key={index} className="border rounded-lg p-4 space-y-3">
                    <div className="flex items-center justify-between">
                      <span className="font-medium text-lg">"{metaphor.content}"</span>
                      <div className="text-right">
                        <div className="text-sm text-gray-600">Influencia</div>
                    ...
                    <Progress value={metaphor.influencePercentage * 100} className="h-2" />
                    <div className="space-y-2">
                      <div>
                        <h4 className="font-medium text-sm text-gray-700">Explicación:</h4>
                        <p className="text-gray-700 text-sm">{metaphor.explanation}</p>
                      </div>
                      <div>
                        <h4 className="font-medium text-sm text-gray-700">Contexto Histórico:</h4>
                        <p className="text-gray-700 text-sm">{metaphor.historicalContext}</p>
                      </div>
                    </div>
                  </div>
                ))}
                ...
                <Card>
                  ...
                  <CardContent className="space-y-3">
                    <div className="flex justify-between items-center">
                      <span className="text-sm text-gray-600">Influencia</span>
                      <span className="font-bold">
                        {Math.round(analysis.additionalContextEvaluation.stereotype.influencePercentage * 100)}%
                      </span>
                    </div>
                    <Progress value={analysis.additionalContextEvaluation.stereotype.influencePercentage * 100} />
                    ...
                    {analysis.additionalContextEvaluation.stereotype.examples.length > 0 && (
                      <div>
                        <h4 className="font-medium text-sm text-gray-700 mb-2">Ejemplos:</h4>
                        <ul className="list-disc list-inside text-sm text-gray-600 space-y-1">
                          {analysis.additionalContextEvaluation.stereotype.examples.map((example, i) => (
                            <li key={i}>{example}</li>
                          ))}
                        </ul>
                      </div>
                ...
                <Card>
                  ...
                  <CardContent className="space-y-3">
                    <div className="flex justify-between items-center">
                      <span className="text-sm text-gray-600">Influencia</span>
                      <span className="font-bold">
                        {Math.round(analysis.additionalContextEvaluation.powerAsymmetry.influencePercentage * 100)}%
                      </span>
                    </div>
                    <Progress value={analysis.additionalContextEvaluation.powerAsymmetry.influencePercentage * 100} />
                    <p className="text-sm text-gray-700">
                    ...
                    {analysis.additionalContextEvaluation.powerAsymmetry.examples.length > 0 && (
                      <div>
                        <h4 className="font-medium text-sm text-gray-700 mb-2">Ejemplos:</h4>
                        <ul className="list-disc list-inside text-sm text-gray-600 space-y-1">
                          {analysis.additionalContextEvaluation.powerAsymmetry.examples.map((example, i) => (
                            <li key={i}>{example}</li>
                          ))}
                        </ul>
                      </div>
                ...
                <Card>
                  ...
                  <CardContent className="space-y-3">
                    <div className="flex justify-between items-center">
                      ...
                      <span className="font-bold">
                        {Math.round(
                          analysis.additionalContextEvaluation.genderRepresentationAbsence.influencePercentage * 100,
                        )}
                        %
                      </span>
                    </div>
                    <Progress
                      value={analysis.additionalContextEvaluation.genderRepresentationAbsence.influencePercentage * 100}
                    />
                    <p className="text-sm text-gray-700">
                      {analysis.additionalContextEvaluation.genderRepresentationAbsence.explanation}
                    </p>
                    {analysis.additionalContextEvaluation.genderRepresentationAbsence.affectedGroups.length > 0 && (
                      <div>
                        <h4 className="font-medium text-sm text-gray-700 mb-2">Grupos Afectados:</h4>
                ...
                <Card>
                  ...
                  <CardContent className="space-y-3">
                    <div className="flex justify-between items-center">
                      <span className="text-sm text-gray-600">Influencia</span>
                      <span className="font-bold">
                        {Math.round(analysis.additionalContextEvaluation.intersectionality.influencePercentage * 100)}%
                      </span>
                    </div>
                    <Progress
                      value={analysis.additionalContextEvaluation.intersectionality.influencePercentage * 100}
                    />
                    <p className="text-sm text-gray-700">
                    ...
                    {analysis.additionalContextEvaluation.intersectionality.excludedGroups.length > 0 && (
                      <div>
                        <h4 className="font-medium text-sm text-gray-700 mb-2">Grupos Excluidos:</h4>
                        <div className="flex flex-wrap gap-2">
                          {analysis.additionalContextEvaluation.intersectionality.excludedGroups.map((group, i) => (
                            <Badge key={i} variant="outline">
                              {group}
                            </Badge>
                          ))}
                ...
                <Card className="lg:col-span-2">
                  ...
                  <CardContent className="space-y-3">
                    <div className="flex justify-between items-center">
                      <span className="text-sm text-gray-600">Influencia</span>
                      <span className="font-bold">
                        {Math.round(analysis.additionalContextEvaluation.systemicBiases.influencePercentage * 100)}%
                      </span>
                    </div>
                    <Progress value={analysis.additionalContextEvaluation.systemicBiases.influencePercentage * 100} />
                    <p className="text-sm text-gray-700">
                    ...
                    {analysis.additionalContextEvaluation.systemicBiases.examples.length > 0 && (
                      <div>
                        <h4 className="font-medium text-sm text-gray-700 mb-2">Ejemplos:</h4>
                        <ul className="list-disc list-inside text-sm text-gray-600 space-y-1">
                          {analysis.additionalContextEvaluation.systemicBiases.examples.map((example, i) => (
                            <li key={i}>{example}</li>
                          ))}
                        </ul>
                      </div>
          ...
          <TabsContent value="alternatives" className="space-y-6">
            {analysis.modifiedTextAlternatives.map((alternative, index) => (
              <Card key={index}>
                <CardHeader>
                  <CardTitle>Alternativa {alternative.alternativeNumber}</CardTitle>
                  <CardDescription>Versión modificada del texto original sin sesgos de género</CardDescription>
                </CardHeader>
                <CardContent className="space-y-4">
                  <div className="bg-green-50 border border-green-200 rounded-lg p-4">
                    <p className="text-gray-900 leading-relaxed">{alternative.alternativeText}</p>
                  </div>

                  <Separator />

                  <div>
                    <h4 className="font-medium text-gray-900 mb-3">Modificaciones Realizadas:</h4>
                    <div className="space-y-3">
                      {alternative.modificationsExplanation.map((mod, modIndex) => (
                        <div key={modIndex} className="border rounded-lg p-3 space-y-2">
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                              <h5 className="text-sm font-medium text-red-700 mb-1">Original:</h5>
                              <p className="text-sm bg-red-50 p-2 rounded">"{mod.originalFragment}"</p>
                            </div>
                            <div>
                              <h5 className="text-sm font-medium text-green-700 mb-1">Modificado:</h5>
                              <p className="text-sm bg-green-50 p-2 rounded">"{mod.modifiedFragment}"</p>
                            </div>
                          </div>
                          <div>
                  ...
                  <CardContent>
                    <div className="space-y-3">
                      <div className="flex items-center gap-2">
                        ...
                        >
                          {analysis.impactAnalysis.accessToCare.affected ? "Afectado" : "No Afectado"}
                        </Badge>
                      </div>
                  ...
                  <CardContent>
                    <div className="space-y-3">
                      <div className="flex items-center gap-2">
                        ...
                        >
                          {analysis.impactAnalysis.stigmatization.affected ? "Afectado" : "No Afectado"}
                        </Badge>
                      </div>
                      <p className="text-gray-700 text-sm leading-relaxed">
