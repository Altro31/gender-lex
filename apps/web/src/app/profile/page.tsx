...
const mockActivities = [
  {
    ...
    description: "Completado análisis de sesgo de género en documento académico",
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">Gestiona tu información personal y configuraciones de cuenta</p>
        </div>
              ...
              <CardContent className="space-y-4">
                <div className="space-y-3">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-sm font-medium">{getProviderLabel(user.provider)}</span>
                  </div>
                  ...
                  {user.loggedAt && (
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-sm font-medium">{formatDateTime(user.loggedAt)}</span>
                    </div>
                  )}
                </div>
                  ...
                  <AlertDialog open={isLogoutDialogOpen} onOpenChange={setIsLogoutDialogOpen}>
                    ...
                    <AlertDialogContent>
                      <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>
                          ¿Estás seguro de que quieres cerrar tu sesión? Tendrás que volver a iniciar sesión para
                          acceder a tu cuenta.
                        </AlertDialogDescription>
                      </AlertDialogHeader>
                      <AlertDialogFooter>
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="space-y-2">
                          ...
                          <Textarea
                            ...
                            maxLength={500}
                          />
                          <p className="text-xs text-gray-500">{editForm.biography.length}/500 caracteres</p>
                        </div>
                        ...
                        {user.biography && (
                          <div className="space-y-2">
                            ...
                            <div className="bg-gray-50 rounded-lg p-4">
                              <p className="text-gray-900 leading-relaxed">{user.biography}</p>
                            </div>
                          </div>
                        )}
                      </div>
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            {activity.status && (
                              ...
                              >
                                ...
                                {activity.status === "running" && "En Progreso"}
                              </Badge>
                            )}
                          </div>
                        </div>
                    ...
                    {mockActivities.length === 0 && (
                      <div className="text-center py-8">
                        ...
                        <p className="text-gray-600">
                          Tus acciones aparecerán aquí una vez que comiences a usar la plataforma
                        </p>
                      </div>
                    )}
                  </CardContent>
